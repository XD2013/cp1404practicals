...
def pharase_to_sentence(phrase):
    '''
    >>> pharase_to_sentence('hello')
    'Hello.'
    >>> pharase_to_sentence('It is an ex parrot.')
    'It is an ex parrot.'
    >>> pharase_to_sentence('Now it is metal time')
    'Now it is metal time.'
    '''
